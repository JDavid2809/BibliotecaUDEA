...
import Image from "next/image"
    ...
    return (
        ...
        <div className="bg-white shadow-xl rounded-2xl overflow-hidden w-full max-w-5xl flex flex-col md:flex-row">
            ...
            <h2 className="text-3xl font-bold mb-8 text-gray-800 border-b pb-4">Editar Libro</h2>
            ...
            <div className="space-y-6">
                ...
                <div className="relative">
                    ...
                    />
                    <BookText className="absolute left-4 top-3.5 text-emerald-600" size={20} />
                </div>
                </div>
                ...
                <div className="relative">
                    ...
                    />
                    <User className="absolute left-4 top-3.5 text-emerald-600" size={20} />
                </div>
                </div>
                ...
                <div>
                    ...
                    <School className="absolute left-4 top-3.5 text-emerald-600" size={20} />
                ...
                <div>
                    ...
                    <Calendar className="absolute left-4 top-3.5 text-emerald-600" size={20} />
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                        <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                        </svg>
                ...
                <div>
                    ...
                    <Pencil className="absolute left-4 top-3.5 text-emerald-600" size={20} />
                    <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
                        <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                        </svg>
