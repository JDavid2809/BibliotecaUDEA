    ...
    return (
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <input
                    type="email"
                    placeholder="Ingresa tu correo example@gmail.com"
        ...
        <div className="border-t border-gray-200 mt-8 pt-4 flex flex-col md:flex-row items-center justify-between">
            <p className="text-gray-500 text-sm">2023 furino. All rights reserved</p>
